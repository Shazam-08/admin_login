    ...
    <div className="flex justify-center">
      <div className="max-w-xs mx-4">
        <div className="bg-white rounded-lg shadow-md p-6 mb-4">
          <h3 className="text-lg font-semibold mb-2 cursor-pointer hover:text-blue-500" onClick={handleBookingClick}>
            Bookings
          </h3>
          <p className="text-gray-600">Click here to navigate to bookings.</p>
        </div>
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-lg font-semibold mb-2 cursor-pointer hover:text-blue-500" onClick={handleBatterySwapClick}>
            Battery Swap
          </h3>
          <p className="text-gray-600">Click here to navigate to battery swap.</p>
        </div>
      </div>
    </div>
  );
